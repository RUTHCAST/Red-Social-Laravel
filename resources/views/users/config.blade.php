...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card">
                <div class="card-header"><h4>Configuracion de mi Cuenta</h4></div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{route('user.update')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <label for="image_file" class="col-md-4 col-form-label text-md-right">{{ __('Avatar') }}</label>

                            <div class="col-md-6">
                                @include('includes\avatar')
                                <input id="image_file" type="file" class="form-control @error('image_file') is-invalid @enderror" name="image_file" autocomplete="image_file">
